...
export type AdminUsersQuery = { users: { __typename: 'UserPage', totalCount: number, offset: number, users: Array<{ __typename: 'User', id: string, username: string, role: string }> } };
