...
export type GetCategoriesQuery = { getCategories: Array<{ __typename: 'Category', id: string, name: string, listId: string }> };
...
export type GetCategoryUpdatesSubscription = { getCategoryUpdates: { __typename: 'CategoryUpdate', type: CategoryUpdateType, item: { __typename: 'Category', id: string, name: string, listId: string } } };
...
export type GetItemsQuery = { getItems: Array<{ __typename: 'Item', id: string, name: string, checked: boolean, category: string, listId: string, store: string | null, recurring: string | null, addedBy: string | null, deleted: boolean, deletedAt: string | null, checkedAt: string | null }> };
...
export type SaveItemMutation = { saveItem: { __typename: 'Item', id: string, name: string, checked: boolean, category: string, listId: string, store: string | null, recurring: string | null, addedBy: string | null, deleted: boolean, deletedAt: string | null, checkedAt: string | null } };
...
export type CheckItemMutation = { checkItem: { __typename: 'Item', id: string, checked: boolean, checkedAt: string | null } };
...
export type UncheckItemMutation = { uncheckItem: { __typename: 'Item', id: string, checked: boolean, checkedAt: string | null } };
...
export type GetItemUpdatesSubscription = { getItemUpdates: { __typename: 'ItemUpdate', type: ItemUpdateType, item: { __typename: 'Item', id: string, name: string, checked: boolean, category: string, listId: string, store: string | null, recurring: string | null, addedBy: string | null, deleted: boolean, deletedAt: string | null, checkedAt: string | null } } };

export type ListsQueryVariables = Exact<{ [key: string]: never; }>;


export type ListsQuery = { lists: { __typename: 'ListsResult', lists: Array<{ __typename: 'List', id: string, name: string, emoji: string | null, createdAt: string, ownerId: string, ownerUsername: string, uncheckedItemCount: number, members: Array<{ __typename: 'ListMember', userId: string, username: string, status: string }> }>, pendingInvites: Array<{ __typename: 'PendingInvite', listId: string, listName: string, listEmoji: string | null, ownerUsername: string }> } };
...
export type CreateListMutation = { createList: { __typename: 'List', id: string, name: string, emoji: string | null, ownerId: string, ownerUsername: string, createdAt: string, uncheckedItemCount: number, members: Array<{ __typename: 'ListMember', userId: string, username: string, status: string }> } };
...
export type AcceptInviteMutation = { acceptInvite: { __typename: 'List', id: string, name: string, emoji: string | null, ownerId: string, ownerUsername: string, createdAt: string, uncheckedItemCount: number, members: Array<{ __typename: 'ListMember', userId: string, username: string, status: string }> } };
...
export const SaveCategoryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SaveCategory"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"listId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"saveCategory"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"category"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"listId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"listId"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"listId"}}]}}]}}]} as unknown as DocumentNode<SaveCategoryMutation, SaveCategoryMutationVariables>;
export const GetCategoryUpdatesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"GetCategoryUpdates"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"listId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getCategoryUpdates"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"listId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"listId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"item"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"listId"}}]}}]}}]}}]} as unknown as DocumentNode<GetCategoryUpdatesSubscription, GetCategoryUpdatesSubscriptionVariables>;
