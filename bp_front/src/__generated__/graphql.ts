...
export type ItemsQuery = { getItems: Array<{ __typename: 'Item', id: string, name: string, checked: boolean, category: string, listId: string, store: string | null, addedBy: string | null }> };
...
export type ItemUpdatesSubscription = { getItemUpdates: { __typename: 'ItemUpdate', type: ItemUpdateType, item: { __typename: 'Item', id: string, name: string, checked: boolean, category: string, listId: string, store: string | null, addedBy: string | null, deleted: boolean } } };
