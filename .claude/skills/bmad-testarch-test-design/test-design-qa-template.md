...
**Purpose:** Map NFR requirements to planned validation work. This section defines what evidence QA should create or
collect; it does not assign final PASS/CONCERNS/FAIL status.
...
**Missing thresholds or evidence sources:** {List NFRs that need stakeholder clarification or tooling before
`nfr-assess`.}
